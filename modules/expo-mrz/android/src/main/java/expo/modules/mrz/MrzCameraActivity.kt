...
class MrzCameraActivity : MrzReaderActivity() {
    ...
    private fun setupWindowInsets() {
        val rootView = findViewById<View>(R.id.layout_camera)
        val bottomPanel = rootView.findViewById<GridLayout>(R.id.bottom_panel)
        ...
        ViewCompat.setOnApplyWindowInsetsListener(rootView) { view, insets ->
            ...
            bottomPanel?.setPadding(
                ...
                bottomPanel.paddingBottom + systemBars.bottom
            )
    ...
    override fun onSuccess(s: String) {
        try {
            ...
            Log.e(TAG, "MrzCameraActivity - Error parsing MRZ JSON: ${e.message}", e)
            onFailure(e)
        }
    }
    ...
    override fun onFailure(throwable: Throwable) {
        isProcessFinished = true
        Log.e(TAG, "MrzCameraActivity - MRZ scanning failed: ${throwable.message}")
    }
    ...
    private fun chooseOptimalSize(
        ...
        return when {
            ...
            notBigEnough.size > 0 -> Collections.max(notBigEnough, CompareSizesByArea())
                ...
                Log.e(TAG, "MrzCameraActivity - Couldn't find any suitable preview size")
                choices[1]
            }
        }
    }
