...
export const devConfig: ApiConfig = {
  baseUrl: 'https://demo.udentify.io/api',
  baseURL: 'https://demo.udentify.io/api', // For VideoCallTab compatibility
  wssURL: 'wss://livekit.np.fraud.com', // WebSocket URL for video calls - matching Flutter
  clientName: 'TestClient_Expo', // Client name for video calls
...
export const prodConfig: ApiConfig = {
  ...
  baseURL: 'https://demo.udentify.io/api', // For VideoCallTab compatibility
  wssURL: 'wss://livekit.np.fraud.com', // WebSocket URL for video calls - matching Flutter
  clientName: 'TestClient_Expo_Prod', // Client name for video calls
  apiKey: 'EcNzFN26S24/uf1tv7d+FXHgAPMzEye8',
  timeout: 30000,
  retryAttempts: 3,
};
...
export const testConfig: ApiConfig = {
  baseUrl: 'https://test.udentify.io/api', // Update this if you have a test environment
  wssURL: 'wss://livekit.np.fraud.com', // WebSocket URL for video calls - matching Flutter
  clientName: 'TestClient_Expo_Test', // Client name for video calls
